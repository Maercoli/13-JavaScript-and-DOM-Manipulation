...
function runEnter() {
    ...
    //var filteredData = reports.filter(report => report.city === inputValue);
    //var filteredData = reports.filter(report => report.state === inputValue);
    //var filteredData = reports.filter(report => report.country === inputValue);
    //var filteredData = reports.filter(report => report.shape === inputValue);
    ...
    //var cities = filteredData.map(city => city.city);
